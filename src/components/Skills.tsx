      ...
      <div className="container mx-auto px-6">
        <motion.div ref={ref} variants={containerVariants} initial="hidden" animate={inView ? "visible" : "hidden"}>
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-stone-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-slate-800/50 backdrop-blur-md rounded-2xl p-8 border border-slate-700/50">
                ...
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={skillsData} margin={{
                    top: 20,
                    right: 30,
                    left: 20,
                    bottom: 5
                      ...
                      <Bar dataKey="level" radius={[4, 4, 0, 0]}>
                        {skillsData.map((entry, index) => <Cell key={`cell-${index}`} fill={entry.color} />)}
                      </Bar>
                    </BarChart>
                  </ResponsiveContainer>
                </div>
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              {skillsData.map((skill, index) => <motion.div key={skill.name} initial={{
              opacity: 0,
              x: 50
            }} animate={inView ? {
              opacity: 1,
              ...
              y: -5
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-0 -top-6 text-sm font-semibold" style={{
                  color: skill.color
                }}>
                      {skill.level}%
                    </span>
